// =============================================================
// FEMM CComplex — unified complex number implementation
// Shared by all solvers and liblua
// =============================================================
#ifdef _WIN32
#include <stdafx.h>
#endif
...
CComplex operator+( __int64 x, const CComplex& y )
{
	return CComplex( ((double) x) + y.re, y.im );
}
...
// Comparison operators (compare by real part)
...
bool CComplex::operator<(__int64 z){ return re < (double) z; }
...
{
	// Fast path for purely real arguments in [-1,1]
	if (x.im==0)
	{
...
{
	// Fast path for purely real arguments
...
{
	// Use exact integer exponentiation when possible
