// =============================================================
// FEMM Cuthill-McKee — shared algorithm implementation
// Include this from each solver's cuthill.cpp after:
// 1. Including all solver-specific headers (mesh.h, etc.)
// 2. #define CUTHILL_CLASS CFemmeDocCore  (or Chsolvdoc)
// 3. Optionally #define CUTHILL_HAS_AIR_GAP for fkn/csolv
// =============================================================
#ifndef CUTHILL_IMPL_H
#define CUTHILL_IMPL_H

#ifndef CUTHILL_CLASS
#error "CUTHILL_CLASS must be defined before including cuthill_impl.h"
#endif

#define muo 1.2566370614359173e-6

BOOL CUTHILL_CLASS::SortElements()
{
